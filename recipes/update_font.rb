...
execute "Updates font on the #{term_opts['default_profile']} profile to Menlo-Regular 18pt" do
  command "/usr/libexec/PlistBuddy -c 'import :Window\\ Settings:#{term_opts['default_profile']}:Font #{Chef::Config[:file_cache_path]}/MenloRegular18pt.bin' #{ENV['HOME']}/Library/Preferences/com.apple.Terminal.plist"
